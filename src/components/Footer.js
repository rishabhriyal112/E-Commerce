        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-400">
              Your one-stop shop for quality products at affordable prices. From electronics to fashion, we've got you covered.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/login" className="text-gray-400 hover:text-white">My Account</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/products?category=Electronics" className="text-gray-400 hover:text-white">Electronics</Link>
              </li>
              <li>
                <Link to="/products?category=Fashion" className="text-gray-400 hover:text-white">Fashion</Link>
              </li>
              <li>
                <Link to="/products?category=Home & Kitchen" className="text-gray-400 hover:text-white">Home & Kitchen</Link>
              </li>
              <li>
                <Link to="/products?category=Beauty & Personal Care" className="text-gray-400 hover:text-white">Beauty & Personal Care</Link>
              </li>
            </ul>
          </div>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div>
                <input
                  ...
                  className="w-full px-4 py-2 rounded text-gray-800 focus:ring-2 focus:ring-primary"
                  required
                />
              </div>
              <button
